-- NursePrepIQ 0044: promote cleaned 0042 batch only after required AI-assisted validation gates pass.
...
begin
 ...
 if n <> 108 then
   raise exception '0042 promotion aborted: expected 108 validation-ready questions, found %',n;
 end if;
end $$;
commit;
